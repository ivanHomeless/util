...
if (isset($_POST['command'])) {
  $command = !empty($_POST['command']) ? strip_tags($_POST['command']) : '.';
...
<form action="" method="POST">
  ...
  <fieldset>
    ...
    <input type="text" name="command" class="form-field" />
    <input type="submit" name="execut" class="submit" value="Execute"/>
  </fieldset>
</form>
